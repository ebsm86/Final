const categories = [
  ...
  function generateSQLForDate(date) {
    ...
    categories.forEach(category => {
      const preSaleSingleServe = randomValue(10, 100);
      const budgetSingleServe = randomValue(10, 100);
      const preSaleMultiServe = randomValue(10, 100);
  ...
  const startDate = new Date(2024, 3, 20); // April 20, 2024 (note: January is 0)
  const endDate = new Date(2024, 4, 20); // May 20, 2024
